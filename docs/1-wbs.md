...
| 3.1.1 ユーザー登録 API             | 完了       |      |
| 3.1.2 ログイン API                 | 完了       |      |
| 3.1.3 パスワードリセット API       | 完了       |      |
| 3.1.4 JWT トークン検証ミドルウェア | 完了       |      |
...
| 3.2.1 ログイン画面                            | 完了       |      |
| 3.2.2 ユーザー登録画面                        | 完了       |      |
| 3.2.3 パスワードリセット画面                  | 完了       |      |
| 3.2.4 認証状態管理                            | 完了       |      |
| 3.2.5 E2Eテスト作成（最低限の主要フローのみ） | 完了       |      |
...
| 項目                               | ステータス | Spec |
| :--------------------------------- | :--------- | :--- |
| 4.1.1 プロフィール取得 API         | 完了       |      |
| 4.1.2 プロフィール更新 API         | 完了       |      |
| 4.1.3 アイコン画像アップロード API | 完了       |      |
...
| 4.2.1 プロフィール表示画面                    | 完了       |      |
| 4.2.2 プロフィール編集画面                    | 完了       |      |
| 4.2.3 アイコン画像アップロード                | 完了       |      |
| 4.2.4 E2Eテスト作成（最低限の主要フローのみ） | 完了       |      |
