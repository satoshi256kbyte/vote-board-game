...
| 1.2 ステアリングファイルの作成：機能一覧                    | 完了       |      |
| 1.3 ステアリングファイルの作成：実装ガイド                  |            |      |
| 1.4 基本設計：テーブル設計（DynamoDB Single Table Design）  |            |      |
| 1.5 基本設計：API設計                                       |            |      |
| 1.6 基本設計：URL設計                                       |            |      |
| 1.7 基本設計：画面設計（ワイヤーフレーム）                  |            |      |
...
| 項目                                                      | ステータス | Spec |
| :-------------------------------------------------------- | :--------- | :--- |
| 2.1.1 モノレポ構成のセットアップ（pnpm workspace）        |            |      |
| 2.1.2 AWS CDK プロジェクトのセットアップ                  |            |      |
| 2.1.3 バックエンド（Hono）プロジェクトのセットアップ      |            |      |
