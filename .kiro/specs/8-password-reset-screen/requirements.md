...
本ドキュメントは、投票対局アプリケーションのパスワードリセット画面機能の要件を定義します。パスワードリセット画面は、パスワードを忘れたユーザーがメールアドレスを使用して確認コードを受け取り、新しいパスワードを設定できるようにするフロントエンド機能です。この画面は、既存のパスワードリセットAPI（spec 4）と統合し、2段階のフロー（確認コード送信→パスワードリセット確認）を提供します。
