...
- [ ] 3. InteractiveBoardコンポーネントの実装
  ...
  - [~] 3.8 InteractiveBoardのユニットテストを作成
  ...
  - [~] 3.9 InteractiveBoardのプロパティベーステストを作成
