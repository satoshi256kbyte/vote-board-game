...
- [x] 4. ルーティングレイヤーの拡張
  ...
  - [x] 6.1 リクエストボディバリデーションのプロパティテストを作成
    - fast-check で不正な position / description を生成し、バリデーションエラーを検証
    - _Requirements: 2.3, 2.4, 2.5, 2.6, 2.7_
  - [x] 6.2 成功レスポンスの形式と初期値のプロパティテストを作成
