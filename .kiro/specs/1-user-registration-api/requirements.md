...
本ドキュメントは、投票対局アプリケーションのユーザー登録API機能の要件を定義します。ユーザー登録APIは、新規ユーザーがアカウントを作成し、投票形式のアブストラクト・ゲームに参加できるようにします。このAPIは、認証にAmazon Cognitoを、ユーザーデータの永続化にDynamoDBを統合します。
