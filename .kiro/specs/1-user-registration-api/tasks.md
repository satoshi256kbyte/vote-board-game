...
投票対局アプリケーションのユーザー登録API機能を実装します。この機能は、新規ユーザーがメールアドレス、パスワード、ユーザー名を使用してアカウントを作成し、Amazon Cognitoで認証され、DynamoDBにプロフィール情報を保存できるようにします。
