...
- [ ] 5. サービス層の実装
  ...
  - [~] 5.2 CognitoServiceのユニットテストを作成
    ...
    - Cognitoクライアントをモック
    - _要件: 5.1-5.4, 7.1-7.4_
  - [~] 5.3 CognitoServiceのプロパティテストを作成
...
- [ ] 7. API層の実装
  ...
  - [~] 7.6 Auth Routerのプロパティテストを作成
    - **プロパティ3: メールアドレス重複検証（冪等性）**
    - **検証: 要件 2.3, 13.1, 13.2, 13.3**
  - [~] 7.7 Auth Routerのプロパティテストを作成
    - **プロパティ9: トランザクション整合性（ロールバック）**
    - **検証: 要件 6.5**
  - [~] 7.8 Auth Routerのプロパティテストを作成
    - **プロパティ11: 成功レスポンス形式**
    - **検証: 要件 8.1, 8.2, 8.3, 8.4**
  - [~] 7.9 Auth Routerのプロパティテストを作成
    - **プロパティ13: エラーレスポンス形式**
    - **検証: 要件 10.1, 10.2, 10.3, 10.4**
  - [~] 7.10 Auth Routerのプロパティテストを作成
    - **プロパティ14: CORS設定**
